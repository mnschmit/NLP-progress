...
### AGENDA
The task in [AGENDA](https://github.com/rikdz/GraphWriter) is to take an input graph and a paper title and to produce a scientific abstract. The paper titles and abstracts stem from semantic scholar and the graphs were automatically created with SciIE, an information extraction system for the scientific domain. The automatic creation of the dataset leads to many isolated nodes and disconnected graphs.

* title: Model Uncertainty in Classical Conditioning .
* entities: conditioning # t parameters ; # xed generative model ; spurious correlations ; bayesian model ; world model ; conditioning regimes ; model structure ; second-order conditioning ; conditioned inhibition ; reinforcer delivery
* triples: (second-order conditioning, CONJUNCTION, conditioned inhibition)
...
| ------------- | :-----: | :-----: | :-----: | --- | --- |
| T5-large by Ribeiro et al. (2020) <sup>[[10]](#myfootnote10)</sup> | 59.70 | 0.442 | | [Investigating Pretrained Language Models for Graph-to-Text Generation](https://arxiv.org/pdf/2007.08426.pdf) | [Official](https://github.com/UKPLab/plms-graph2text) |
| T5-base by Ribeiro et al. (2020) <sup>[[10]](#myfootnote10)</sup> | 59.17 | 0.432 | | [Investigating Pretrained Language Models for Graph-to-Text Generation](https://arxiv.org/pdf/2007.08426.pdf) | [Official](https://github.com/UKPLab/plms-graph2text) |
...
<a name="myfootnote10">[10]</a> Leonardo F. R. Ribeiro, Martin Schmitt, Hinrich Schütze, and Iryna Gurevych. "[Investigating Pretrained Language Models for Graph-to-Text Generation
](https://arxiv.org/abs/2007.08426)" arXiv preprint arXiv:2007.08426 (2020).
